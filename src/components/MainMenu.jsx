...
import { bookTitle, itemDescriptions, menuText } from "../utils/TextData";
...
export default function MainMenu({ handleScroll }) {
	...
	return (
		<motion.div className="flex justify-center items-center w-full h-screen bg-[url('/src/assets/menuBg.png')] bg-cover bg-center">
			<div
				...
				<div className="relative flex justify-center items-start">
					...
					<motion.div className="absolute z-20 text-center top-1/4 w-[80%]">
						{bookTitle.map((char, i) => (
							<motion.span
								...
								className="font-felipa text-3xl md:text-5xl lg:text-5xl xl:text-6xl text-[#743841] font-medium leading-tight tracking-wider">
								{char}
							</motion.span>
						))}
					</motion.div>
